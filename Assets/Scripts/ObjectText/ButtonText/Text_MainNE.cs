...
public class Text_MainNE : MonoBehaviour {
	...
	void Update () {
		if (FlagManager.Instance.flags[104] == true && FlagManager.Instance.flags [18] == true)
		{
			score.text = "右上の引き出しを開けた。";
			...
			if (FlagManager.Instance.flags [123] == true)
			{
				...
				if (FlagManager.Instance.flags [124] == true)
				{
					...
					FlagManager.Instance.flags [104] = false;
				}
			}
		}
	}
