...
public class Text_MainNW : MonoBehaviour {
	...
	void Update () {
		if (FlagManager.Instance.flags[102] == true && FlagManager.Instance.flags [18] == true)
		{
			score.text = "左上の引き出しを開けた。";
			...
			if (FlagManager.Instance.flags [123] == true)
			{
				...
				if (FlagManager.Instance.flags [124] == true)
				{
					...
					FlagManager.Instance.flags [102] = false;
				}
			}
		}
	}
