...
public class Item_Kami3 : MonoBehaviour {
	...
	public void Click () {
		...
		GameObject gameObject = this.transform.Find ("kami3_x").gameObject; 
		...
		if (FlagManager.Instance.flags [7] == false && FlagManager.Instance.flags [8] == false) {
			...
			FlagManager.Instance.flags [48] = true;
			...
			GameObject gameObjectA = this.transform.Find ("TextKami3").gameObject;
