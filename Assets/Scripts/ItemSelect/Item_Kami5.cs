...
public class Item_Kami5 : MonoBehaviour {
	...
	public void Click () {
		...
		GameObject gameObject = this.transform.Find ("kami5_x").gameObject; 
		...
		if (FlagManager.Instance.flags [7] == false && FlagManager.Instance.flags [8] == false) {
			...
			FlagManager.Instance.flags [50] = true;
			...
			GameObject gameObjectA = this.transform.Find ("TextKami5").gameObject;
