...
public class Item_Kami4 : MonoBehaviour {
	...
	public void Click () {
		...
		GameObject gameObject = this.transform.Find ("kami4_x").gameObject; 
		...
		if (FlagManager.Instance.flags [7] == false && FlagManager.Instance.flags [8] == false) {
			...
			FlagManager.Instance.flags [49] = true;
			...
			GameObject gameObjectA = this.transform.Find ("TextKami4").gameObject;
