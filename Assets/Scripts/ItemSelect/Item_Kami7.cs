...
public class Item_Kami7 : MonoBehaviour {
	...
	public void Click () {
		...
		GameObject gameObject = this.transform.Find ("kami7_x").gameObject; 
		...
		if (FlagManager.Instance.flags [7] == false && FlagManager.Instance.flags [8] == false) {
			...
			FlagManager.Instance.flags [52] = true;
			...
			GameObject gameObjectA = this.transform.Find ("TextKami7").gameObject;
