...
public class Item_Kami1 : MonoBehaviour {
	...
	public void Click () {
		...
		GameObject gameObject = this.transform.Find ("kami1_x").gameObject; 
		...
		if (FlagManager.Instance.flags [7] == false && FlagManager.Instance.flags [8] == false) {
			...
			FlagManager.Instance.flags [46] = true;
			...
			GameObject gameObjectA = this.transform.Find ("TextKami1").gameObject;
