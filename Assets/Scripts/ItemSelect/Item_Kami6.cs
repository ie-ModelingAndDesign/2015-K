...
public class Item_Kami6 : MonoBehaviour {
	...
	public void Click () {
		...
		GameObject gameObject = this.transform.Find ("kami6_x").gameObject; 
		...
		if (FlagManager.Instance.flags [7] == false && FlagManager.Instance.flags [8] == false) {
			...
			FlagManager.Instance.flags [51] = true;
			...
			GameObject gameObjectA = this.transform.Find ("TextKami6").gameObject;
