...
public class SafeNum2 : MonoBehaviour {
	...
	public void Click ()
	{
		...
		else if (safeNum569.count == 2 && FlagManager.Instance.flags [113] == false && FlagManager.Instance.flags [114] == false && FlagManager.Instance.flags [115] == true)
		{
			FlagManager.Instance.flags [116] = true;
			safeNum569.count++;
		}

		else if (safeNum569.count == 2 && FlagManager.Instance.flags [113] == false && FlagManager.Instance.flags [114] == true && FlagManager.Instance.flags [115] == false)
		{
			FlagManager.Instance.flags [116] = true;
			safeNum569.count++;
		}

		else if (safeNum569.count == 2 && FlagManager.Instance.flags [113] == false && FlagManager.Instance.flags [114] == true && FlagManager.Instance.flags [115] == true)
		{
			FlagManager.Instance.flags [116] = true;
			safeNum569.count++;
		}

		else if (safeNum569.count == 2 && FlagManager.Instance.flags [113] == true && FlagManager.Instance.flags [114] == false && FlagManager.Instance.flags [115] == false)
		{
			FlagManager.Instance.flags [116] = true;
			safeNum569.count++;
		}
